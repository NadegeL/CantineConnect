    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('postal_code', models.CharField(max_length=20, validators=[django.core.validators.RegexValidator(message='The postal code must contain between 3 and 10 alphanumeric characters.', regex='^[A-Z0-9]{3,10}$')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parents', models.ManyToManyField(blank=True, related_name='students', through='api.ParentChildRelation', to='api.parent')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='student',
            name='allergies',
            field=models.ManyToManyField(blank=True, through='api.StudentAllergy', to='api.allergy', verbose_name='Allergies et restrictions alimentaires'),
        ),
    ]
